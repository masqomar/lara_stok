                                ...
                                <table class="table table-striped table-bordered first text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @can('sales.edit')
                                                    <a href="{{ route('admin.sales.edit', $sale->id) }}" class="btn btn-primary btn-sm mr-1"> <i class="fas fa-edit"></i> Edit</a>
                                                @endcan

                                                <a href="#" class="btn btn-info btn-sm rounded-lg mr-1"><i class="fas fa-eye"></i> Show</a>
                                                @can('sales.delete')
                                                <button onclick="Delete(this.id)" class="btn btn-danger btn-sm rounded-lg" id="{{ $sale->id }}"><i class="fa fa-trash" aria-hidden="true"></i> Delete</button>
                                                @endcan
                                            </td>
                                        </tr>
                                        @empty
    ...
    function Delete(id)
    {
        ...
        swal({
            ...
            if(isConfirm){
                // ajax delete
                jQuery.ajax({
                    url: "{{ route('admin.sales.index') }}/" +id,
                    data: {
                        "id": id,
                        "_token": token
                    },
